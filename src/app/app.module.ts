...
@NgModule({
  ...
  imports: [BrowserModule, AppRoutingModule, UsersModule, HomeModule, HttpClientModule, MenusModule, CountriesModule, TeamsModule, ChampionshipModule, SpeedwayModule],
  providers: [],
